...
(function (eqh) {
    ...
    (function (transaction) {
        var PlaceBidOrder = (function (_super) {
            __extends(PlaceBidOrder, _super);
            function PlaceBidOrder(publicKeyValue, ecBlockHeightString, ecBlockIdString, referencedTransactionFullHash, deadlineValue, assetIdString, quantityNQTString, priceNQTString) {
                var _this = _super.call(this, (2 | 0), (3 | 0)) || this;
            ...
            PlaceBidOrder.prototype.createUnsignedBytes = function () {
                var unsignedBytes = "";
            ...
            return PlaceBidOrder;
        }(eqh.transaction.Transaction));
        transaction.PlaceBidOrder = PlaceBidOrder;
        PlaceBidOrder["__class"] = "eqh.transaction.PlaceBidOrder";
